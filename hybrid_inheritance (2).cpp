...
class Result:public Exam,public Sport
{
	...
	public:
		...
		Result(stringint physics,int chemistry,int maths,int eng,int cs,int score):Sport(score),Exam(name,roll_no,aadhar_no,physics,chemistry, maths,eng, cs) 
		{
