...
class Exam 
{
	...
	public:
		Exam (int physics,int chemistry,int maths,int eng,int cs)
		{
...
class Result:public Exam,public  Student
{
	...
	float percentage;
	public:
		Result(string name,int roll_no,long int aadhar_no ,int physics,int chemistry,int maths,int eng,int cs):Student(name,roll_no,aadhar_no),Exam(physics,chemistry, maths,eng, cs) 
		{
...
main()
{
	...
	Result rs("ashish",100180113,99999999L,89,78,78,89,90);
	rs.showdetails();
	//e1.showdetails();
}
